...
public class EditScreen {
	...
	public static final String SHEET_NAME			= "EditProduct";
	...
	public static WebDriver openScreen(String browser) throws Exception {
		...
		if (!browser.isEmpty()) {
			...
			Utilities.clickObscuredElement(driver, ListScreen.DUPLICATE_BTN_XPATH, EditScreen.SAVE_BTN_XPATH);
...
//			Utilities.click(driver, By.xpath(EditScreen.CANCEL_BTN_XPATH));
	...
	public static void editProduct(WebDriver driver, String id, String title, String description, String shortDescription,
